...
export const Pattern = ({shape, pattern, colors, rotate, stroke, width, height, viewbox}) => {
  ...
  const get_rotate = shape === 'cube' ? `rotate(${(rotate || 0) * 90}, 218, 218)` : `rotate(${(rotate || 0) * 60}, 218, 189)` 
